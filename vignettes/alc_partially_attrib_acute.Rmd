...
The Health Survey for England (HSE) provide the basis for our analysis (see the [hseclean R package](https://stapm.gitlab.io/hseclean/) for details of how we process the HSE data).   

...
data <- read_xlsx("vignettes/disease risks/16102018 tobacco and alcohol Disease List and Risk Functions.xlsx", sheet = "TobaccoCI")
...
data_Kontis <- fread("vignettes/disease risks/excess_risk_decline_from_KontisLancet.csv")
...
data_laryngeal <- read_xlsx("vignettes/disease risks/2015-09-06_Risk_changes_after_cessation.xlsx", sheet = "Laryngeal_comparison")
...
data_oropharyngeal <- read_xlsx("vignettes/disease risks/2015-09-06_Risk_changes_after_cessation.xlsx", sheet = "OralPharyngeal_comparison")
...
data_oesophageal <- read_xlsx("vignettes/disease risks/2015-09-06_Risk_changes_after_cessation.xlsx", sheet = "Oesophargeal_comparison")
